...
public class CookieUtils {
        public static void addCookie (String userId, String userName, HttpServletResponse response, HttpServletRequest request){
            if (StringUtils.isNotBlank(userId)) {
                //创建cookie
                Cookie idCookie = new Cookie("geek_userId", userId);
                Cookie nameCookie = new Cookie("geek_userName", userName);
                System.out.println("geek_userId"+userId);
                System.out.println("geek_userName"+userName);
